...
values
  ...
  (14, 1, 14, 4, 5, 3, 4, 'ну надо шарить за плюсы, чтобы сдать'),
  (15, 1, 15, 6, 5, 3, 4, 'слегка душит, но в целом ок'),
  (16, 11, 1, 2, 2, 2, 2, 'ууу злой какой'),
  (17, 11, 2, 2, 2, 2, 2, 'чет плохо посмотрел в мою сторону'),
  (18, 11, 3, 2, 2, 2, 2, 'поставил 3 !!((('),
  (19, 11, 4, 2, 2, 2, 2, 'ничсвывсвысвысвыс'),
  (20, 11, 5, 2, 2, 2, 2, 'спам это спам'),
  (21, 11, 6, 2, 2, 2, 2, '******* *** 8* 8*8 8*'),
  (22, 11, 7, 2, 2, 2, 2, 'dlmlmsmslcms'),
  (23, 11, 8, 2, 2, 2, 2, 'span'),
  (24, 11, 9, 2, 2, 2, 2, 'dncjscjsbcjs'),
  (25, 11, 10, 3, 2, 2, 2, '&***&******'),
  (26, 11, 11, 9, 2, 2, 2, '!#II#III#I#I#I#I#II'),
  (27, 11, 12, 3, 2, 2, 2, '(((((cringe'),
  (28, 11, 13, 4, 2, 2, 2, '+++++++ok'),
  (29, 11, 14, 4, 2, 2, 2, 'its oojdkjenxeknxnxncknekcnecec'),
  (30, 11, 15, 6, 2, 2, 2, 'yalublucringe');